...
func TestUpdateConfirmationThreshold(t *testing.T) {
	tests := []struct {
		...
		{"10000000000000000", 6666666666666667},
		{"100000000000000000", 66666666666666664},
		{"1000000000000000000", 666666666666666624},
		{"10000000000000000000", 6666666666666667008},
		{"100000000000000000000", math.MaxInt64 + 1},
		{"1000000000000000000000", math.MaxInt64 + 1},
	}
