...
describe("Voting", () => {
    ...
    describe("createPoll", () => {
        it("should allow a poll to be created", async () => {
            const result = await voting.createPoll
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("2"))
        ...
        it("should not allow the commit end to be before reveal end", async () => {
            await voting.createPoll
                .sendTransactionAsync(new BigNumber("2"), new BigNumber("1"))
        ...
        it("should not allow the commit end to be equal to reveal end", async () => {
            await voting.createPoll
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"))
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
        });
    });
    ...
    describe("commitVote", () => {
        ...
        it("should allow a user to commit a vote", async () => {
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("1"), secret1, testValues.fiveEther)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
        });
        ...
        it("should require tokens to vote", async () => {
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("1"), secret1, testValues.fiveEther, { from: accounts[2] })
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
        });
        ...
        it("should not let a voter commit twice", async () => {
            await twoOnePoll();
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("2"), secret1, testValues.fiveEther)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("2"), secret1, testValues.fiveEther)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
    ...
    describe("revealVote", () => {
        ...
        it("should allow a user to reveal a vote", async () => {
            ...
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
        });
        ...
        it("should not allow a change in salt", async () => {
            await voting.commitVote
                ...
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"), new BigNumber("24"))
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
        });
        ...
        it("should not allow a change in vote", async () => {
            await voting.commitVote
                ...
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("2"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
        });
        ...
        it("should not allow a voter to reveal twice", async () => {
            ...
            await voting.commitVote
                ...
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("2"), new BigNumber("1"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("2"), new BigNumber("1"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.rejected;
    ...
    describe("winningOption", () => {
        it("should report the correct winningOption", async () => {
            ...
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("1"), secret1, testValues.oneEther)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("1"), secret2, testValues.fiveEther, { from: accounts[1] })
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("2"), salt, { from: accounts[1] })
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;

            await voting.winningOption
                .callAsync(new BigNumber("1"))
                .then(x => x.toString())
                .should.eventually.eq("2");
        });
    ...
    describe("totalWinningTokens", () => {
        it("should report the correct number of total tokens contributed", async () => {
            ...
            await voting.commitVote
                ...
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.commitVote
                .sendTransactionAsync(new BigNumber("1"), secret1, testValues.fiveEther, { from: accounts[1] })
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"), salt)
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
            await voting.revealVote
                .sendTransactionAsync(new BigNumber("1"), new BigNumber("1"), salt, { from: accounts[1] })
                .then(txHash => web3Wrapper.awaitTransactionSuccessAsync(txHash)).should.eventually.be.fulfilled;
    ...
    describe("userWinningTokens", () => {
        it("should report 0 when not a winning vote", async () => {
            ...
            await voting.userWinningTokens
                .callAsync(new BigNumber("1"), accounts[0])
                .then(x => x.toString())
        ...
        it("should report the correct number of tokens", async () => {
            ...
            await voting.userWinningTokens
                .callAsync(new BigNumber("1"), accounts[1])
                .then(x => x.toString())
