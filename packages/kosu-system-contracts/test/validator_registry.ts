...
describe("ValidatorRegistry", async () => {
  ...
  describe("registerListing", () => {
    it("should require a balance greater or equal to the minimumBalance", async () => {
      ...
      await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, testValues.oneEther, testValues.zero, { from }).should.eventually.be.rejected;
    });
    ...
    it("should require an approval greater or equal to the minimumBalance", async () => {
      ...
      await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, testValues.oneEther, testValues.zero).should.eventually.be.rejected;
    });
    ...
    describe("approved", () => {
      ...
      it("should allow registration with the minimumBalance", async () => {
        await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, testValues.oneEther, testValues.zero).should.eventually.be.fulfilled;
      });
      ...
      it("should fail with less tokens than minimum", async () => {
        ...
        await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, minimum.minus(new BigNumber("1")), testValues.zero).should.eventually.be.rejected;
      });
      ...
      it("should fail when you try to generate too many tokens",  async () => {
        ...
        await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, testValues.oneEther, max.plus(new BigNumber("1"))).should.eventually.be.rejected;
      });
      ...
      it("should allow an unbounded ", async () => {
        ...
        await validatorRegistryProxy.registerListing.sendTransactionAsync(tendermintPublicKey, totalTokens, testValues.zero).should.eventually.be.fulfilled;
  ...
  describe("confirmListing", () => {
    it("should not confirm a null listing", async () => {
      await validatorRegistryProxy.confirmListing.sendTransactionAsync(tendermintPublicKey).should.eventually.be.rejected;
    });
    ...
    describe("preparedListing tests", () => {
      ...
      it("should not confirm a challenged listing", async () => {
        ...
        await validatorRegistryProxy.challengeListing.sendTransactionAsync(tendermintPublicKey).should.eventually.be.fulfilled;
        await validatorRegistryProxy.confirmListing.sendTransactionAsync(tendermintPublicKey).should.eventually.be.rejected;
      });

      it("should only let the listing owner confirm the listing", async () => {
        await validatorRegistryProxy.confirmListing.sendTransactionAsync(tendermintPublicKey, { from: accounts[1] }).should.eventually.be.rejected;
      });
  ...
  describe("initExit", () => {
    ...
    it("should not allow an exit with a pending challenge", async () => {
      ...
      await validatorRegistryProxy.challengeListing.sendTransactionAsync(tendermintPublicKey, { from: accounts[1] }).should.eventually.be.fulfilled;

      await validatorRegistryProxy.initExit.sendTransactionAsync(tendermintPublicKey).should.eventually.be.rejected;
    });
    ...
    it("should only let the owner initExit", async () => {
      await validatorRegistryProxy.initExit.sendTransactionAsync(tendermintPublicKey, { from: accounts[1] }).should.eventually.be.rejected;
    });
  });
  ...
  describe("finalizeExit", () => {
    ...
    it("should not allow a listing to exit until after the exit period", async () => {
      ...
      await treasury.currentBalance.callAsync(accounts[0]).then(r => r.toString()).should.eventually.eq("0");
      await validatorRegistryProxy.initExit.sendTransactionAsync(tendermintPublicKey).should.eventually.be.fulfilled;
      await validatorRegistryProxy.finalizeExit.sendTransactionAsync(tendermintPublicKey).should.eventually.be.rejected;
    });
    ...
    it("should only let the owner finalizeExit", async () => {
      ...
      await validatorRegistryProxy.initExit.sendTransactionAsync(tendermintPublicKey).should.eventually.be.fulfilled;
      await exitSkip();
      await validatorRegistryProxy.finalizeExit.sendTransactionAsync(tendermintPublicKey, { from: accounts[1] }).should.eventually.be.rejected;
    });
  ...
  describe("challengeListing", () => {
    ...
    it("should require tokens approved to challenge", async () => {
      await kosuToken.transfer.sendTransactionAsync(accounts[1], testValues.oneEther);
      await validatorRegistryProxy.challengeListing.sendTransactionAsync(tendermintPublicKey, { from: accounts[1] }).should.eventually.be.rejected;
    });
