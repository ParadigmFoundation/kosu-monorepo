import { AuthorizedAddressesContract, ValidatorRegistryContract, VotingContract, KosuTokenContract, TreasuryContract, EventEmitterContract, OrderGatewayContract, PosterRegistryContract, ZeroExV2SubContractContract, BasicTradeSubContractContract } from "@kosu/system-contracts";
import { BigNumber } from "@0x/utils";
import { Web3Wrapper } from "@0x/web3-wrapper";
import { Provider, LogWithDecodedArgs } from "ethereum-types";
...
export interface KosuUtils {
    toBytes32(value: string): number | string | BigNumber;
    NULL_ADDRESS: string;
}
