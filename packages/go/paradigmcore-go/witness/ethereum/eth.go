...
var _ witness.Provider = &EthereumProvider{}
...
func (w *EthereumProvider) HandleEvents(ctx context.Context, fn func(e *witness.Event)) error {
...
func handlePosterRegistryUpdate(evt *EventEmitterParadigmEvent) (*witness.Event, error) {
	if len(evt.Data) != 2 {
...
func (w *EthereumProvider) HandleBlocks(ctx context.Context, fn func(hdr *witness.Block)) error {
